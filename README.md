...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FIn-Time-Tec%2Fatlas&env=APP_URL,ALLOWED_ORIGINS,XAI_API_KEY,OPENAI_API_KEY,ANTHROPIC_API_KEY,GROQ_API_KEY,GOOGLE_GENERATIVE_AI_API_KEY,DAYTONA_API_KEY,DATABASE_URL,BETTER_AUTH_SECRET,GITHUB_CLIENT_ID,GITHUB_CLIENT_SECRET,GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET,TWITTER_CLIENT_ID,TWITTER_CLIENT_SECRET,REDIS_URL,ELEVENLABS_API_KEY,ELEVENLABS_TTS_BASE_URL,ELEVENLABS_DEFAULT_VOICE_ID,TAVILY_API_KEY,EXA_API_KEY,TMDB_API_KEY,YT_ENDPOINT,FIRECRAWL_API_KEY,OPENWEATHER_API_KEY,GOOGLE_MAPS_API_KEY,MAPBOX_ACCESS_TOKEN,AMADEUS_API_KEY,AMADEUS_API_SECRET,COINGECKO_API_KEY,AVIATION_STACK_API_KEY,CRON_SECRET,BLOB_READ_WRITE_TOKEN,MEM0_API_KEY,MEM0_ORG_ID,MEM0_PROJECT_ID,SMITHERY_API_KEY,QSTASH_TOKEN,RESEND_API_KEY,SCIRA_TASKS_ENDPOINT,COMPANY_WEBSITE_URL,EMAIL_ASSET_ICON_URL,NEXT_PUBLIC_APP_URL,NEXT_PUBLIC_MAPBOX_TOKEN,NEXT_PUBLIC_POSTHOG_KEY,NEXT_PUBLIC_POSTHOG_HOST,NEXT_PUBLIC_GOOGLE_MAPS_API_KEY,NEXT_PUBLIC_GOOGLE_MAPS_PLACE_URL_TEMPLATE,NEXT_PUBLIC_GOOGLE_MAPS_SEARCH_URL_TEMPLATE,NEXT_PUBLIC_GOOGLE_FAVICON_URL,NEXT_PUBLIC_OG_CHAT_URL_TEMPLATE,NEXT_PUBLIC_ATLAS_API_BASE_URL&envDescription=API%20keys%20and%20configuration%20required%20for%20Atlas%20to%20function)
